...
build: 
	build-linux build-windows build-osx 

build-worldr-linux:
	@echo Build Worldr extension for Linux
	env GOOS=linux GOARCH=amd64 ./worldr/build.sh

build-worldr-osx:
	@echo Build Worldr extension for OSX
	env GOOS=darwin GOARCH=amd64 ./worldr/build.sh

build-worldr-windows:
	@echo Build Worldr extension for Windows
	env GOOS=windows GOARCH=amd64 ./worldr/build.sh

build-worldr:
	@echo Build Worldr extension for current platform
	./worldr/build.sh
