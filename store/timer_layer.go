...
func (s *TimerLayerChannelStore) GetGlobalChannels(teamId string, userId string) (*model.ChannelSnapshotList, *model.AppError) {
	start := timemodule.Now()
	...
	if s.Root.Metrics != nil {
		...
		s.Root.Metrics.ObserveStoreMethodDuration("ChannelStore.GetGlobalChannels", success, elapsed)
	}
	return resultVar0, resultVar1
}
...
func (s *TimerLayerChannelStore) GetPersonalChannels(teamId string, userId string) (*model.ChannelSnapshotList, *model.AppError) {
	...
	if s.Root.Metrics != nil {
		...
		s.Root.Metrics.ObserveStoreMethodDuration("ChannelStore.GetPersonalChannels", success, elapsed)
	}
	return resultVar0, resultVar1
}
...
func (s *TimerLayerChannelStore) GetWorkChannels(teamId string, userId string) (*model.ChannelSnapshotList, *model.AppError) {
	start := timemodule.Now()
	...
	if s.Root.Metrics != nil {
		...
		s.Root.Metrics.ObserveStoreMethodDuration("ChannelStore.GetWorkChannels", success, elapsed)
	}
	return resultVar0, resultVar1
}
...
func (s *TimerLayerPostStore) GetRecentPosts(channelIds *[]string, perChannel int) (*[]model.Post, *model.AppError) {
	start := timemodule.Now()
	...
	if s.Root.Metrics != nil {
		...
		s.Root.Metrics.ObserveStoreMethodDuration("PostStore.GetRecentPosts", success, elapsed)
	}
	return resultVar0, resultVar1
}
...
func (s *TimerLayerTeamStore) MainTeam() (*model.Team, *model.AppError) {
	start := timemodule.Now()
	...
	if s.Root.Metrics != nil {
		...
		s.Root.Metrics.ObserveStoreMethodDuration("TeamStore.MainTeam", success, elapsed)
	}
	return resultVar0, resultVar1
}
