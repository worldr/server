...
// GetAllPostsAfter provides a mock function with given fields: channels, includeIds, postCountsByChannel
func (_m *PostStore) GetAllPostsAfter(channels *[]model.ChannelWithPost, includeIds *[]string, postCountsByChannel *map[string]int) (*map[string]*[]*model.Post, *model.AppError) {
	ret := _m.Called(channels, includeIds, postCountsByChannel)

	var r0 *map[string]*[]*model.Post
	if rf, ok := ret.Get(0).(func(*[]model.ChannelWithPost, *[]string, *map[string]int) *map[string]*[]*model.Post); ok {
		r0 = rf(channels, includeIds, postCountsByChannel)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*map[string]*[]*model.Post)
		}
	}

	var r1 *model.AppError
	if rf, ok := ret.Get(1).(func(*[]model.ChannelWithPost, *[]string, *map[string]int) *model.AppError); ok {
		r1 = rf(channels, includeIds, postCountsByChannel)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*model.AppError)
		}
...
// GetOldestPostsForChannels provides a mock function with given fields: channelIds
func (_m *PostStore) GetOldestPostsForChannels(channelIds *[]string) (*map[string]string, *model.AppError) {
...
// GetPostCountAfter provides a mock function with given fields: channels
func (_m *PostStore) GetPostCountAfter(channels *[]model.ChannelWithPost) (int64, *model.AppError) {
	ret := _m.Called(channels)

	var r0 int64
	if rf, ok := ret.Get(0).(func(*[]model.ChannelWithPost) int64); ok {
		r0 = rf(channels)
	} else {
		r0 = ret.Get(0).(int64)
	}
	...
	var r1 *model.AppError
	if rf, ok := ret.Get(1).(func(*[]model.ChannelWithPost) *model.AppError); ok {
		r1 = rf(channels)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*model.AppError)
...
// GetPostCountAfterForChannels provides a mock function with given fields: channels
func (_m *PostStore) GetPostCountAfterForChannels(channels *[]model.ChannelWithPost) (*map[string]int, *model.AppError) {
	ret := _m.Called(channels)

	var r0 *map[string]int
	if rf, ok := ret.Get(0).(func(*[]model.ChannelWithPost) *map[string]int); ok {
		r0 = rf(channels)
	} else {
		if ret.Get(0) != nil {
...
// GetTotalPosts provides a mock function with given fields: channelIds
func (_m *PostStore) GetTotalPosts(channelIds *[]string) (int64, *model.AppError) {
	ret := _m.Called(channelIds)
...
// GetTotalPostsForChannels provides a mock function with given fields: channelIds
func (_m *PostStore) GetTotalPostsForChannels(channelIds *[]string) (*map[string]int, *model.AppError) {
	ret := _m.Called(channelIds)
