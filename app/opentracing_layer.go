...
func (a *OpenTracingAppLayer) CheckIncrementPossible(request *model.IncrementCheckRequest) (bool, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.CheckIncrementPossible")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.CheckIncrementPossible(request)
...
func (a *OpenTracingAppLayer) GetAllUsersPaginated(fromIndex uint64, perPage uint64) ([]*model.User, uint64, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetAllUsersPaginated")
	...
	defer span.Finish()
	resultVar0, resultVar1, resultVar2 := a.app.GetAllUsersPaginated(fromIndex, perPage)
...
func (a *OpenTracingAppLayer) GetChannelImage(channelId string) ([]byte, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetChannelImage")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetChannelImage(channelId)
...
func (a *OpenTracingAppLayer) GetChannelsCategories(userId string) (*model.ChannelCategoriesList, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetChannelsCategories")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetChannelsCategories(userId)
...
func (a *OpenTracingAppLayer) GetPersonalChannels(teamId string, userId string) (*model.ChannelSnapshotList, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetPersonalChannels")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetPersonalChannels(teamId, userId)
...
func (a *OpenTracingAppLayer) GetRecentPosts(request *model.RecentPostsRequestData) (*model.PostListSimple, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetRecentPosts")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetRecentPosts(request)
...
func (a *OpenTracingAppLayer) IsAdminUsername(teamId string, userName string) (bool, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.IsAdminUsername")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.IsAdminUsername(teamId, userName)
...
func (a *OpenTracingAppLayer) MainTeam() (*model.Team, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.MainTeam")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.MainTeam()
...
func (a *OpenTracingAppLayer) SetChannelImageFromFile(channelId string, file io.Reader) *model.AppError {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.SetChannelImageFromFile")
	...
	defer span.Finish()
	resultVar0 := a.app.SetChannelImageFromFile(channelId, file)
...
func (a *OpenTracingAppLayer) SetChannelImageFromMultiPartFile(channelId string, file multipart.File) *model.AppError {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.SetChannelImageFromMultiPartFile")
	...
	defer span.Finish()
	resultVar0 := a.app.SetChannelImageFromMultiPartFile(channelId, file)
